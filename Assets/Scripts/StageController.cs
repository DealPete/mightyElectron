...
public class StageController : LevelController {
	...
	public GameObject setupEditorLevel() {
		GameLevel gameLevel = Serializer.LoadTemporaryLevel(this);
	...
	public GameObject setupLevel(int level) {
		if (level == 1) {
			Junction j1 = addJunction(new Vector3(0,10));
			Junction j2 = addJunction(new Vector3(0,5));
			Junction j3 = addJunction(new Vector3(0,0));
			Junction j4 = addJunction(new Vector3(5,10));
			Junction j5 = addJunction(new Vector3(5,0));
			Junction j6 = addJunction(new Vector3(10,10));
			Junction j7 = addJunction(new Vector3(10,5));
			Junction j8 = addJunction(new Vector3(10,0));
			...
			Junction j1 = addJunction(new Vector3(0, 20));
			Junction j2 = addJunction(new Vector3(0, 15));
			Junction j3 = addJunction(new Vector3(0, 10));
			Junction j4 = addJunction(new Vector3(0, 5));
			Junction j5 = addJunction(new Vector3(0, 0));
			Junction j6 = addJunction(new Vector3(5, 20));
			Junction j7 = addJunction(new Vector3(5, 10));
			Junction j8 = addJunction(new Vector3(5, 5));
			Junction j10 = addJunction(new Vector3(10, 20));
			Junction j11 = addJunction(new Vector3(10, 15));
			Junction j12 = addJunction(new Vector3(10, 10));
			Junction j13 = addJunction(new Vector3(10, 5));
			Junction j14 = addJunction(new Vector3(10, 0));
			Junction j15 = addJunction(new Vector3(15, 20));
			Junction j16 = addJunction(new Vector3(15, 15));
			Junction j17 = addJunction(new Vector3(15, 10));
			Junction j18 = addJunction(new Vector3(15, 5));
			Junction j19 = addJunction(new Vector3(15, 0));
			Junction j20 = addJunction(new Vector3(20, 20));
			Junction j21 = addJunction(new Vector3(20, 15));
			Junction j22 = addJunction(new Vector3(20, 10));
			Junction j23 = addJunction(new Vector3(20, 5));
			Junction j24 = addJunction(new Vector3(20, 0));
			...
			Junction junc = addJunction (new Vector3 (10, 15));
